describe('Registration Test', () => {
    ...
    it('should show error message for password mismatch', () => {
        cy.fillOutRegistrationForm('test@example.com', 'password', 'differentPassword');
